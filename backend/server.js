/**
 * server.js — hollr.to API Backend (v5.2.2)
 *
 * Routes overview
 * ───────────────
...
app.get('/health', (_req, res) => res.json({ ok: true, version: '5.2.2' }));
...
app.listen(PORT, () => {
  console.log(`📢 hollr API v5.2.2 running on port ${PORT} [${process.env.NODE_ENV || 'development'}]`);
});
